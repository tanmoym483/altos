                    ...
                    <div class="card m-4">
                        <section>
                            <div class="scooter-upload p-2">
                                ...
                                <form action="<?php echo base_url("admin/posteditdiagonstic") ?>" class="validation-form-message" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="form-outline mb-4 col-sm-4">
                                        ...
                                        <input type="text"  class="form-control" placeholder="First Name" name="firstName" value="<?=$users[0]->firstName?>"  required="" />
                                        ...
                                        <div class="form-outline mb-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Last Name" name="lastName" value="<?=$users[0]->lastName?>" required="" />
