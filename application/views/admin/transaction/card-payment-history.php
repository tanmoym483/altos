...
<section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Transactions For card active</h1>
                </div>
                <div class="col-sm-6">
                <?php if($_GET['to'] == ''){ ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('/dashboard'); ?>">Home</a></li>
                        <li class="breadcrumb-item active">Transactions For Card Active</li>
                    </ol>
                    <?php } else { ?>
                    <ol class="breadcrumb float-sm-right">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Total Spending Balance For Card Active</th>
                        </tr>
                    </thead>
                    <tbody>
                    
                        <tr>
                            <td>Transactions For card active</td>
