...
<section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Transactions For CashBack</h1>
                </div>
                <div class="col-sm-6">
                <?php if($_GET['to'] == ''){ ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('/dashboard'); ?>">Home</a></li>
                        <li class="breadcrumb-item active">Transactions For CashBack</li>
                    </ol>
                    <?php } else { ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('cashback/cashbackTransactionHistory'); ?>" class="btn btn-primary">Back</a></li>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Total Spending Balance For CashBack</th>
                        </tr>
                    </thead>
                    <tbody>
                    
                        <tr>
                            <td>Transactions For CashBack</td>
                            ...
                            <table class="table table-bordered exportable" style="font-size:14px;" >
                                ...
                                <tbody>
                                    ...
                                    foreach( $data['result'] as $key=>$payment){?>
                                        ...
                                        <td>Debited</td>
                                        <td><?=$payment['firstName'].' '.$payment['lastName']?>
                                        <?php if($role == 'superAdmin'){?>
