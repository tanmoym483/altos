...
<section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Transactions For CSP Registration</h1>
                </div>
                <div class="col-sm-6">
                <?php if($_GET['to'] == ''){ ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('/dashboard'); ?>">Home</a></li>
                        <li class="breadcrumb-item active">Transactions For CSP Registration</li>
                    </ol>
                    <?php } else { ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('bankcsp/cspTransactionHistory'); ?>" class="btn btn-primary">Back</a></li>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Total Spending Balance For CSP Registration</th>
                        </tr>
                    </thead>
                    <tbody>
                    
                        <tr>
                            <td>Transactions For CSP Registration</td>
                    ...
                    <div class="table-responsive" >
                                ...
                                <tbody>
                                    ...
                                    foreach( $data['result'] as $key=>$payment){
                                        ...
                                        <td><?php 
                                                        ...
                                                        ?></td>
                                        <td><?=$payment['rcreatedAt']?></td>
                                        <td>Debited</td>
                                        <td><?=$payment['firstName'].' '.$payment['lastName']?> - <?=$payment['application_id']?> Transaction: <?=$payment['transRefNo']?> 
                                        <?php if($role == 'superAdmin'){?>
                            ...
                            <table id="mytable" style="display:none;"  >
                                ...
                                <tbody>
                                    ...
                                    <?php  foreach( $data['alldata'] as $key=>$payment){?>
                                        <tr> 
                                            <td><?=$key+1?></td>
                                        <td><?=date('d-m-Y',strtotime($payment['rcreatedAt']))?></td>
                                        <td>Debited</td>
                                        <td><?=$payment['firstName'].' '.$payment['lastName']?> - <?=$payment['application_id']?>
                                        <?php if($role == 'superAdmin'){?>
                                            <?='By '.$payment['cfirstName'].' '.$payment['clastName']?>
                                        <?php } ?>
                                    </td>
