      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          <div class="card shadow-sm border-0 rounded-3 text-center p-4">
            ...
            <h3 class="fw-bold text-danger">40</h3>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card shadow-sm border-0 rounded-3 text-center p-4">
            <h6 class="text-muted mb-2">Stock</h6>
            <h3 class="fw-bold text-success">40</h3>
          </div>
        </div>
      </div>
      ...
      <div class="card shadow-sm border-0 rounded-3 p-3 mb-4">
        <div class="d-flex justify-content-center gap-4">
          <div class="form-check">
            <input type="checkbox" class="form-check-input" id="purchaseIn">
            <label class="form-check-label fw-semibold" for="purchaseIn">Add Purchase Product</label>
          </div>
          <div class="form-check">
            <input type="checkbox" class="form-check-input" id="sellsout">
