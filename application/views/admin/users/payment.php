...
<div class="container p-4">
    <div class="card p-3">
        <main class="app-content">
            ...
            <div id="introducerfund">
               
                <form method="post" enctype="multipart/form-data" class="validation-form-message" action="<?php echo base_url("users/addvendorfund") ?>" >
                    
                    <div class="row">
                        <?php if ($_SESSION['role'] === "superAdmin") { ?>
                            <div class="col-md-12 mb-3" id="franchise_wallet_amount"></div>
                            <input type="hidden" name="vuserId" value="" id="userId">
                            
                            <div class="col-md-3 mb-3">
                                <label class="d-block ">Franchise code <span style="color:#C00">*</span></label>
                                <input type="text" class="form-control" name="introducer_code" placeholder="Introducer code" id="sopnsercode" oninput="regintrFunction()" required="">
                            </div>
                        ...
                        <input type="hidden" name="vuserId" value="<?=$this->session->userdata('userId')?>" id="userId">
                        <div class="col-md-12 mb-3">In wallet <?=$user[0]->wallet?></div>
                        <?php } ?>
                        
                        <input type="hidden" name="transType" value="deposite" >
                        <div class="col-md-3 mb-3">
                            <label class="d-block ">Amount <span style="color:#C00">*</span></label>
                            <input type="number"  name="amount" class="form-control col-xs-8" placeholder="Amount" id="amount" required="" value="" min="599">
                        </div>
                        <?php if ($_SESSION['role'] === "vendor") { ?>
                            <input type="hidden" name="offer_id" value="" id="offer_id">
                            <div class="col-md-2 mb-3 cashback_input" style="display:none">
                        ...
                        <?php } ?>
                        <div class="col-md-3 mb-3">
                            <label class="d-block ">Payment Reference No <span style="color:#C00">*</span></label>
                        ...
                        <!-- <div class="col-md-3 mb-3">
                            ...
                            <input type="file" name="transRefDoc" required class="form-control col-xs-8 crop_image" value="" id="upload_image" onClick="addPayment()">
                            <input type="text" name="transRefDocs" class="form-control col-xs-8 crop_image"  id="upload_imagess" style="display:none">
                            <input type="hidden" name="transRefDoc" id="transRefDocId">
                           
                        </div> -->
                        <div class="col-md-3 mb-3 h-50 image-container">
