    ...
    <div class="card p-3">
        <main class="app-content">
            <div class="app-title">
                ...
                <?php } ?>
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url("users/postcardactive") ?>" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text"  name="card_number" class="form-control col-xs-8" placeholder="Card Number" id="cardnumber" required="" >
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-control" name="payment_form"  required="">
                                ...
                                <option value="own_wallet">Own wallet</option>
                               
                            </select>
                        </div>
                        <div class="col-md-3 mb-3" id="balence" style="align-content: end;font-weight: bold;"></div>
