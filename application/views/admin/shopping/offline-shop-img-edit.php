                ...
                <div class="col-md-12">
                    <div class="card m-4">
                        <section>
                            ...
                            <?php } ?>
                                <form action="<?php echo base_url('shopping/posteditofflineLink') ?>" method="POST"  class="repeater validation-form-message" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label>Shopping Discount amount <span style="color:#C00">*</span></label>
                                            <input type="number" name="link" class="form-control col-xs-8" placeholder="Shopping Discount amount" required="" value="<?=$data->discount?>">
                                        </div>
                                      
                                        <div class="col-md-1 mb-3">
                                            <label>Units <span style="color:#C00">*</span></label>
                                            <select class="form-control" name="units" required="">
                                                <option value="percentage" <?=($data->units == 'percentage')?'selected':''?>>%</option>
                                                <option value="rupess" <?=($data->units == 'rupess')?'selected':''?>>Rs.</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-control" name="shop" required>
                                                ...
                                                <?php foreach($shop as $s) { ?>
                                                    <option value="<?=$s->userId?>" <?=($data->shop == $s->userId)?'selected':''?>><?=$s->center_name?></option>
                                                <?php } ?>
                                            </select>
