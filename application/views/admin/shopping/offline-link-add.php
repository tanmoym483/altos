                ...
                <div class="col-md-12">
                    <div class="card m-4">
                        <section>
                            ...
                            <?php } ?>
                                <form action="<?php echo base_url('shopping/postaddofflineLink') ?>" method="POST"  class="repeater validation-form-message" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" name="link" class="form-control col-xs-8" placeholder="Shopping Discount amount" required="">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="radio" name="special_offer"  value="true" checked > Yes
                                            <input type="radio" name="special_offer" value="false"  > No
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-control" name="shop" required>
                                                ...
                                                <?php foreach($shop as $s) { ?>
                                                    <option value="<?=$s->userId?>"><?=$s->center_name?></option>
                                                <?php } ?>
                                            </select>
