...
<section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Active Card Member list</h1>
                </div>
                <div class="col-sm-6">
                    <?php if(!isset($_GET['card_search'])){ ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('/dashboard'); ?>">Home</a></li>
                        <li class="breadcrumb-item active">Active Card Member list</li>
                    </ol>
                    <?php } else { ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('admin/vendoractivecustomer'); ?>" class="btn btn-primary" >Back</a></li>
...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="input-group input-group-sm" style="width: 250px; ">
                            ...
                            <table class="table table-bordered" id="myTable" data-ordering="false" style="font-size:14px;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($customerlist)) { ?>
                                        ...
                                        <?php 
                                        //$sno = $customers['row']+1;
                                        foreach ($usercards as $key => $customer) {
                                        
                                        ?>
                                            <tr>
                                               
                                                <td><?php echo $customerlist[0]['cardnumber']; ?></td>
                                                <td><?php echo $customer['name']; ?></td>
                                               
                                                <td><?php echo $customerlist[0]['email'] ?></td>
                                                <td><?php echo $customer['phone']; ?></td>
                                                <td><?php echo $customerlist[0]['address'].' '.$customerlist[0]['city'].' '.$customerlist[0]['district'].' '.$customerlist[0]['state'].' '.$customerlist[0]['postcode']; ?></td>
                                                <td><?php echo date('d/m/Y',strtotime($customer['birthday'])); ?></td>
                                              
                                                <td> <?php
                                                   
                                                   if($customerlist[0]['card_status'] == 'active')
                                                   echo '<strong class="text-success">'.$customerlist[0]['card_status'].'</strong>';
                                                   if($customerlist[0]['card_status'] == 'inactive')
                                                   echo '<strong style="color:#f6d1d5">'.$customerlist[0]['card_status'].'</strong>';?></td>
                                                <td>15,000
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        ...
                                        <?php 
                                        //$sno = $customers['row']+1;
                                        foreach ($membercard as $key => $customer) {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $customer['email'] ?></td>
                                                <td><?php echo $customer['ucphone']; ?></td>
                                                <td><?php echo $customer['address'].' '.$customer['city'].' '.$customer['district'].' '.$customer['state'].' '.$customer['postcode']; ?></td>
                                                <td><?php echo $customer['ucbirthday']; ?></td>
