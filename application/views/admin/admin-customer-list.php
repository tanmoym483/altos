        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <?php if(!isset($_GET['card_search'])){ ?>
                    ...
                    <?php } else { ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('admin/admin_customer_list'); ?>" class="btn btn-primary">Back</a></li>
                        ...
                        <form method="get"> 
                            ...
                            <div class="col-md-2">
                                <div class="input-group input-group-sm" >
                                    <input type="text" name="card_search" class="form-control float-right" value="<?=(isset($_GET['card_search'])?$_GET['card_search']:'')?>" placeholder="Cardnumber Search">
                                </div>
                            </div>
                                        ...
                                        ?>
                                            <tr>
                                               <td><?=$key+1?></td>
                                                ...
                                                <td><?php echo $customer->cfirstName.' '.$customer->clastName.'<br>'.$customer->cregId ?></td>
                                                ...
                                                <td> <?php
                                                   ...
                                                   echo '<strong style="color:#f6d1d5">'.$customer->card_status.'</strong>';?></td>
                                                <td>
                                                
                                                     
                                                <a href="<?=base_url('user-details')?>/<?=$customer->id?>"><i class="fa fa-eye"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                    ...
                    <table id="mytable" style="display:none;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10px">Card Number</th>
                                        <th>Name</th>
                                        <th>Created By</th>
                                        <th>Email</th>
                                        <th>Phone Number</th>
