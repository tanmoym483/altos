        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <?php if(!isset($_GET['card_search'])){ ?>
                    ...
                    <?php } else { ?>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('admin/customer_list'); ?>" class="btn btn-primary" >Back</a></li>
            ...
            <div class="col-lg-10">
               <form method="get"> 
                   <div class="row">
                       ...
                       <div class="col-md-2">
                           <div class="input-group input-group-sm" >
                                   <input type="text" name="fname_search" class="form-control" placeholder="FirstName Search" value="<?=(isset($_GET['fname_search'])?$_GET['fname_search']:'')?>">
                           </div>
                       </div>
                       <div class="col-md-2">
                           <div class="input-group input-group-sm" >
                                   <input type="text" name="lname_search" class="form-control" placeholder="LastName Search" value="<?=(isset($_GET['lname_search'])?$_GET['lname_search']:'')?>">
                           </div>
                       </div>
                       <div class="col-md-2">
        ...
        <div class="card-body">
                    <div class="table-responsive" >
                                    ...
                                    <?php if (!empty($customers)) { ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-transform: uppercase;"><?php echo $customer->firstName . ' ' . $customer->middleName . ' ' . $customer->lastName; ?>
                                                <?php echo $customer->regId; ?></td>
                                                <td style="text-transform: uppercase;"><?php echo $customer->cfirstName.' '.$customer->clastName.'<br>'.$customer->cregId ?></td>
                                                ...
                                                <?php
                                                    ...
                                                    echo '<strong style="color:#f6d1d5">'.$customer->card_status.'</strong>';?>
                                                <?php //echo $customer->card_status; ?>
                                            </td>
                                                <td>
                                                <?php
                                                if( $this->session->role == 'superAdmin' ) { ?>       
                                                <a href="<?=base_url('admin/customer_edit')?>/<?=$customer->id?>" class="text-danger"><i class="fa fa-pen"></i></a><?php } ?> 
                                                <?php
                                                if(($this->session->role == 'superAdmin') && $customer->card_status == "active" ) { ?>       
                                                <a href="<?=base_url('user-details')?>/<?=$customer->id?>"><i class="fa fa-eye"></i></a><?php } ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                            ...
                            <div style='margin-top: 10px;'>
                                <div class="text-center pagination"><?php if(isset($customers['pagination'])) { echo $customers['pagination']; }?></div>
                            </div>
                            </div>
                            <table id="mytable" style="display:none;">
                                ...
                                <tbody>
                                     ...
                                     <?php if (!empty($customers)) { ?>
                                         <?php 
                                         foreach ($customers['alldata'] as $key => $customer) {?>
                                            <tr>
                                                <td><?=$key+1?></td>
                                                <td><?php echo $customer->cardnumber; ?></td>
                                                <td style="text-transform: uppercase;"><?php echo $customer->firstName . ' ' . $customer->middleName . ' ' . $customer->lastName; ?>
                                                ...
                                                <td><?php echo $customer->address.' '.$customer->city.' '.$customer->district.' '.$customer->state.' '.$customer->postcode; ?></td>
                                                <td><?php echo date('d/m/Y',strtotime($customer->birthday)); ?></td>
                                                <td style="text-transform: uppercase;"><?php echo $customer->card_status; ?></td>
                                            </tr>
                                    <?php } } ?>
                                </tbody>
                            </table>
