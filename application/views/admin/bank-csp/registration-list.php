...
<div class="content-wrapper" style="min-height: 2080.26px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>CSP Registration</h1>
                </div>
                <div class="col-sm-6">
                
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('/dashboard'); ?>">Home</a></li>
                        <li class="breadcrumb-item active">CSP Registration</li>
                    </ol>
...
<?php if ($_SESSION['role'] == "vendor") { ?>
                   <div class="p-2">
                        <a href="<?php echo base_url('bankcsp/registration') ?>" class="btn btn-primary">Create CSP Registration</a>
                   </div> <?php } ?>
                   <div></div>
                   <div class="p-2 mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $u->bankName .' - '.$u->branchCode; ?></td>
